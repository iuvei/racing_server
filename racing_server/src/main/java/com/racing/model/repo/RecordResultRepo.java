...
public class RecordResultRepo {
  ...
  public boolean upaddTotalStakeAmount(String racingNum, BigDecimal addTotalStakeAmount, Integer addTotalStakeCount) {
    if (addTotalStakeAmount == null || addTotalStakeAmount.compareTo(BigDecimal.ZERO) == 0) {
      return true;
    }
    mapper.upaddTotalStakeAmount(racingNum, addTotalStakeAmount, addTotalStakeCount);
    return true;
  }
