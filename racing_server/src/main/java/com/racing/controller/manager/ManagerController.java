...
public class ManagerController {
    ...
    @ApiOperation(value = "总盘-用户管理-总盘用户管理-新增用户")
    @RequestMapping(value = "/manager", method = RequestMethod.POST)
    public Object addManagerInfo(@RequestBody Manager manager) {
        return managerService.addManger(manager.getNickName(), manager.getUserName(), manager.getPassword());
    }
}
